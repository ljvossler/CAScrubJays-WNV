...
# trimming
FASTAS=/xdisk/mcnew/scrubjays_wnv/aphelocoma_sequence_data/fastqs_all # format must be samplename_
...
MININD=1 # minimum number of individuals required for a site to be kept
