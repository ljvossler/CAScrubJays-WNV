...
write.table(top_windows, file.path(outdir, paste0(outprefix,".composite_score.additive.0.1perc.tsv")), sep = "\t", row.names = FALSE, quote = FALSE)
...
top_windows <- df_clean[df_clean$composite_score >= cutoff, ]
df_clean$highest_composite <- df_clean$composite_score >= cutoff
write.table(top_windows, file.path(outdir, paste0(outprefix,".composite_score.additive.1perc.tsv")), sep = "\t", row.names = FALSE, quote = FALSE)
