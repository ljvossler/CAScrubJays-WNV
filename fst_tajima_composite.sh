...
FST="${OUTDIR}/analyses/fst/ccgp_jays_pre_ccgp_jays_post/10000/ccgp_jays_pre_ccgp_jays_post.10000.fst"
...
'  ${FST_SORTED} ${TAJIMA_SORTED} | sort -k1,1 -k2,2n | tr ' ' '\t' > ${OUTDIR}/analyses/fst_tajima_combined_stats.tsv


# Clean up
rm "$FST_SORTED" "$TAJIMA_SORTED" 

wc -l ${OUTDIR}/analyses/fst_tajima_combined_stats.tsv
grep -v 'NA' ${OUTDIR}/analyses/fst_tajima_combined_stats.tsv | wc -l
